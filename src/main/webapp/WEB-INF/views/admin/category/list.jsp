...
<c:url var="NewURL" value="/admin/the-loai/danh-sach" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<div class="main-content">
		<form action="<c:url value="/admin/the-loai/danh-sach"/>"
							...
							<div class="pull-right tableTools-container">
								<div class="dt-buttons btn-overlap btn-group">
									<a flag="info"
										...
										href='<c:url value="/admin/the-loai/chinh-sua"/>'> <span>
											...
											<tr>
												...
												<td>
												 ...
												 --> <a class="btn btn-sm btn-primary btn-edit"
													...
													href='<c:url value="/admin/the-loai/chinh-sua?id=${item.id}"/>'><i
